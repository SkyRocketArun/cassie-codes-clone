        ...
        >
            ...
            <g data-name={1}>
                ...
                <g>
                    ...
                    />
                    <path fill="#6fdcbf" d="M89.1 224.33H100.3V226.12H89.1z" />
                    <path fill="#6fdcbf" d="M89.1 226.93H100.3V228.72H89.1z" />
                    <path
                        fill="#dd859c"
                ...
                <path fill="#404040" d="M10.16 266.81H109.99V271.04H10.16z" />
                <g onClick={() => setTheme(theme === "light" ? "dark" : "light")} style={{ cursor: 'pointer' }}>
                    <path
                ...
                <g>
                    ...
                    <g clipPath="url(#a)">
                        ...
                        />
                        <g className="webpage" clipPath="url(#b)">
                            <rect
                                x={133.88}
                                y={243.41}
                                width={52.47}
                    ...
                    />
                    <ellipse cx={136.91} cy={246.08} rx={0.93} ry={0.92} fill="#afafaf" />
                    <ellipse cx={140.38} cy={246.08} rx={0.93} ry={0.92} fill="#eaeaea" />
                    <ellipse cx={143.69} cy={246.08} rx={0.93} ry={0.92} fill="#afafaf" />
                    <path
                        fill="#eaeaea"
