...
const GsapTest = () => {
    ...
    return (
        <div>
            ...
            <div style={{
                transform: `translate(${globalCoords.x}px, ${globalCoords.y}px)`,
                position: 'absolute',
                width: '50px',
                height: '50px',
                margin: '0px auto',
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            ...
                                            strokeWidth="1.04"
                                            d="M120.73 78.924a9 9 0 00-4-1.22 9.8 9.8 0 00-4.19.87"
                                        ...
                                        <path
                                            ...
                                            strokeLinejoin="round"
                                            strokeWidth="1.04"
                                            d="M97.12 79.341a9.53 9.53 0 00-4-1.11 10.58 10.58 0 00-4.2.76"
                                        ...
                                        ></path>
                                        <g className="mouth-g"
                                        // style={{ transform: 'matrix(0.4, 0, 0.5, 1.2, 60, 10)' }}
                                        >
                                            <path
                                                fill="none"
                                                stroke="#b5aa9a"
